...
const modalCopy = {
    de: {
        ...
        intro: "Nimm dir mit, was dich gerade stärkt: drei Meditationen, unser vollständiger Vortrag und das begleitende Workbook.",
        recording: "Vortrag ansehen",
        workbook: "Workbook herunterladen",
        meditations: "3 Meditationen hören",
        name: "Dein Name",
    ...
    tr: {
        ...
        intro: "Şu anda sana iyi gelecek içerikleri keşfet: üç meditasyon, seminer kaydının tamamı ve eşlik eden çalışma kitabı.",
        recording: "Semineri izle",
        workbook: "Çalışma kitabını indir",
        meditations: "3 meditasyonu dinle",
        name: "Adın",
