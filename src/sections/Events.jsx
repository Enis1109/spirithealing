import { ArrowRight, CalendarDays, Clock3, ExternalLink, MonitorPlay, Sparkles, UsersRound } from "lucide-react";
            ...
            <section className="relative border-b border-white/10">
                ...
                <div className="relative mx-auto grid w-full max-w-6xl gap-10 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1.12fr_0.88fr] lg:items-center lg:px-8">
                    ...
                    <aside className="glass-strong rounded-[2rem] p-5 shadow-2xl shadow-black/15 sm:p-7" aria-label={copy.live}>
                        ...
                        <a href={zoomUrl} target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-full bg-primary px-5 py-3.5 text-center font-bold text-primary-foreground transition hover:bg-surface">
                            {copy.join}
