            ...
            <header className="border-b border-[#0f8b8d]/15 bg-[#fffaf2]">
                <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
                    <Link to="/" className="flex items-center gap-3">
                        ...
                        <div><strong className="block">Spirit Healing</strong><span className="text-sm text-[#648082]">Zepter-Pilotbegleitung</span></div>
                    </Link>
                        ...
                        {step === 5 && (
                            <StepShell eyebrow="Schritt 6 von 6" title="Was du für einen sicheren Rahmen brauchst" intro="Diese letzten Fragen helfen uns einzuschätzen, wie wir dich verantwortungsvoll und respektvoll begleiten können.">
                                ...
                                <div className="space-y-4 rounded-3xl border border-[#d4af37]/45 bg-[#fbf5df] p-5 sm:p-6">
                                    <div className="flex items-start gap-3"><ShieldCheck className="mt-0.5 h-6 w-6 shrink-0 text-[#806918]" /><div><h3 className="font-bold">Vertrauliche Verarbeitung</h3><p className="mt-1 text-sm leading-6 text-[#665f49]">Deine Angaben werden zur Vorbereitung, Durchführung und Auswertung der Pilotbegleitung gespeichert und sind nur über geschützte, berechtigte Zugänge einsehbar. Du kannst deine Einwilligung für die Zukunft widerrufen und Auskunft oder Löschung verlangen.</p></div></div>
                                    <label className="flex cursor-pointer items-start gap-3 text-sm leading-6 text-[#3e5455]"><input type="checkbox" name="privacyConsent" checked={form.privacyConsent} onChange={handleChange} required className="mt-1 h-5 w-5 shrink-0 accent-[#0f8b8d]" /><span>Ich willige ausdrücklich ein, dass meine hier gemachten – möglicherweise auch gesundheitsbezogenen – Angaben für die beschriebene Pilotbegleitung verarbeitet werden.<span className="ml-1 text-[#a05a35]" aria-hidden="true">*</span></span></label>
