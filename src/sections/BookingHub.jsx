        ...
        options: [
            {
                ...
                people: [
                    ["Mit Sabine", bookingLinks.introSabine],
                    ["Mit Selcan", bookingLinks.introSelcan],
                ],
            },
            {
                icon: UserRound,
                ...
                price: "222 € · 60 Min.",
                people: [
                    ["Erstsitzung mit Sabine", bookingLinks.firstSabine],
                    ["Erstsitzung mit Selcan", bookingLinks.firstSelcan],
                ],
            },
            {
                icon: UsersRound,
                ...
                price: "333 € · 60 Min.",
                people: [
                    ["Gemeinsame Erstsitzung", bookingLinks.combinedFirst],
                ],
            },
        ],
        ...
        options: [
            {
                ...
                people: [
                    ["Sabine ile", bookingLinks.introSabine],
                    ["Selcan ile", bookingLinks.introSelcan],
                ],
            },
            {
                icon: UserRound,
                ...
                price: "222 € · 60 dk.",
                people: [
                    ["Sabine ile ilk seans", bookingLinks.firstSabine],
                    ["Selcan ile ilk seans", bookingLinks.firstSelcan],
                ],
            },
            {
                icon: UsersRound,
                ...
                price: "333 € · 60 dk.",
                people: [
                    ["Ortak ilk seans", bookingLinks.combinedFirst],
                ],
            },
        ],
